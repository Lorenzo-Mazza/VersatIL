...
class DETRVAE(nn.Module):
    ...
    def forward(self, observation: Dict[str, torch.tensor],
        ...
        decoder_output = self.transformer(input_features=fused_image_features,
                              ...
                              additional_positional_embedding=self.additional_pos_embed.weight)[0] # (num_queries, B, hidden)
        ...
        return predicted_actions, predicted_gripper_actions, predicted_pad_mask, [mu, logvar]
