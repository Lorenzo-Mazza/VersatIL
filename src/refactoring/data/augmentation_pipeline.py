...
class AugmentationPipeline:
    ...
    def __init__(
        self,
        color_augmentation: DictConfig | None = None,
        spatial_augmentation: DictConfig | None = None,
        rotation_augmentation: DictConfig | None = None,
        ...
        """
        self.use_color = color_augmentation is not None and train
        self.use_spatial = spatial_augmentation is not None and train
        self.use_rotation = rotation_augmentation is not None and train
