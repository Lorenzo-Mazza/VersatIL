...
class FASTDETRDecoderConfig(DecodingNetworkConfig):
    ...
    _target_: str = (
        "refactoring.models.decoding.decoders.factory.fast_detr_decoder.FASTDETRDecoder"
    )
...
class FASTGPTDecoderConfig(DecodingNetworkConfig):
    ...
    _target_: str = (
        "refactoring.models.decoding.decoders.factory.fast_gpt_decoder.FASTGPTDecoder"
    )
