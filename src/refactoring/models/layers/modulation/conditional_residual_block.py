...
class ConditionalResidualBlock1D(nn.Module):
    def __init__(self,
        ...
        self.blocks = nn.ModuleList([
            Conv1dBlock(input_channels, output_channels, kernel_size, n_groups=num_groups),
            Conv1dBlock(output_channels, output_channels, kernel_size, n_groups=num_groups),
        ])
        ...
        self.residual_convolution = nn.Conv1d(input_channels, output_channels, 1) \
