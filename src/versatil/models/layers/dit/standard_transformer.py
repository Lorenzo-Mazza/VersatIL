"""
Diffusion Transformer inspired by the original implementation by Peebles and Xie.
...
class DiffusionTransformer(nn.Module):
    ...
    output tokens conditioned on (timestep + encoder output mean) via Adaptive Layer Norm plus gating.
    """
    def __init__(
        self,
