"""Diffusion Transformer decoder for timestep-conditioned generation."""
...
class DiffusionTransformerDecoder(nn.Module):
    ...
    def forward(
        ...
        Args:
            ...
            conditioning_embedding: Conditioning vector (B, D).
            padding_mask: Optional padding mask (B, T) where True means masked.
