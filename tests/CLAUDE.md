...
11. **Follow root `CLAUDE.md` coding rules.** In particular:
   - No inline imports.
...
- `tests/models/encoding/encoders/cross_modal/vision_language/test_generative_vlm.py` — fixture-level `params=` auto-parametrising over multiple implementations, session-scoped real-model factories.
